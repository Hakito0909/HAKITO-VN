...
\033[1;34m╔═════════════════════════════════════════════════════════════════           
           ...
           ██║  ██║██║  ██║██║  ██╗██║   ██║   ╚██████╔╝
\033[1;34m╠═════════════════════════════════════════════════════════════════
\033[1;32m║➢ ADMIN      : HAKITO                                   
\033[1;36m║➢ Youtube    : NONE                  
\033[1;31m║➣ TELEGRAM   : NONE                
\033[1;33m║➣ TIKTOK     : NONE                  
\033[1;34m╚═════════════════════════════════════════════════════════════════
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'''
...
{red}MỌI NGƯỜI {cyan}CHÚ Ý!!!!
 ...
 [HKT]{blue}KIỂM TRA KHÔNG THẤY LÊN XU KO PHẢI DO TOOL LỖI 
 [HKT]{pink}MÀ DO HỆ THỐNG GOLIKE CHƯA LOAD!!!
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'''
  pr3(text)
...
'User-Agent':"Mozilla/5.0 (iPhone; U; CPU iPhone OS 4_3_5 like Mac OS X; en-us) AppleWebKit/533.17.9 (KHTML, like Gecko) Version/5.0.2 Mobile/8L1 Safari/6533.18.5"
    ...
    while True:
      ...
      try:
        ...
        # Thay đổi: Mở link bằng TikTok Studio qua intent Android
        open_cmd = f'am start -a android.intent.action.VIEW -d "{link}" com.tiktok.studio'
        open_result = os.system(open_cmd)
        if open_result != 0:
            print(f"{red}❌ Lỗi mở link trong TikTok Studio. Kiểm tra app cài đặt hoặc package name.")
...
def creat_key():
  ...
  characters_to_choose_from = 'qwertyuiopasdghjklzxcvbnmQWERTYUIOPASDGHJKLZXCVBNM123456789'
  characters = 'qwertyuiopasdghjklzxcvbnmQWERTYUIOPASDGHJKLZXCVBNM123456789'
...
while True:
  ...
  print(f'{pink}VERSION 1.5.0 (Sửa mở link bằng TikTok Studio)')
